...
export default function TimeAttackMode() {
  ...
  return (
    <div className="theme-page game-screen h-screen flex flex-col overflow-hidden bg-[radial-gradient(circle_at_top,#78350f_0%,#020617_72%)] px-4 py-4 text-white sm:px-6">
