...
const addContent = async () => {
  try {
    ...
    const getLid = (name) => {
        ...
        if (!l) {
            console.warn(`⚠️  Không tìm thấy bài học nào cho từ khóa: "${name}". Đang dùng bài học mặc định.`);
    ...
    const newQuestions = [
      { content: "Lê Lợi phất cờ khởi nghĩa Lam Sơn tại tỉnh nào?", options: ["Thanh Hóa", "Nghệ An", "Hà Tĩnh", "Ninh Bình"], correctAnswer: "Thanh Hóa", explanation: "Khởi nghĩa Lam Sơn nổ ra năm 1418 tại vùng núi Lam Sơn, Thanh Hóa.", lessonId: getLid("Hậu Lê"), difficulty: 2 },
      { content: "Ai là người soạn thảo bản 'Bình Ngô Đại Cáo'?", options: ["Lê Lợi", "Nguyễn Trãi", "Trần Nguyên Hãn", "Lê Văn Hưu"], correctAnswer: "Nguyễn Trãi", explanation: "Nguyễn Trãi thay lời Lê Lợi viết Bình Ngô Đại Cáo năm 1428.", lessonId: getLid("Hậu Lê"), difficulty: 1 },
      ...
      { content: "Bác Hồ đọc bản Tuyên ngôn Độc lập tại đâu?", options: ["Quảng trường Ba Đình", "Dinh Độc Lập", "Nhà hát Lớn", "Kinh thành Huế"], correctAnswer: "Quảng trường Ba Đình", explanation: "Ngày 2/9/1945 tại Quảng trường Ba Đình, Hà Nội.", lessonId: getLid("Kháng Chiến"), difficulty: 1 },
